...
const statusConfig = {
  ...
  [TicketStatus.Open]: { icon: AlertCircle, color: "text-yellow-400", bg: "bg-yellow-500/10", border: "border-yellow-500/20" },
  [TicketStatus.InProgress]: { icon: Loader2, color: "text-purple-400", bg: "bg-purple-500/10", border: "border-purple-500/20" },
  [TicketStatus.Resolved]: { icon: CheckCircle, color: "text-green-400", bg: "bg-green-500/10", border: "border-green-500/20" },
  [TicketStatus.Closed]: { icon: XCircle, color: "text-gray-400", bg: "bg-gray-500/10", border: "border-gray-500/20" },
  [TicketStatus.Reopened]: { icon: AlertCircle, color: "text-orange-400", bg: "bg-orange-500/10", border: "border-orange-500/20" }
};
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        <span className={`text-xs font-semibold px-2 py-1 rounded-full ${config.bg} ${config.border} ${config.color}`}>
                      ...
                      <div className="flex items-center gap-4 mt-3 text-xs text-gray-500">
                        ...
                        {(ticket.messagesCount || (ticket.messages && ticket.messages.length) || 0) > 0 && (
                          <span className="flex items-center gap-1">
                            <MessageSquare className="w-3 h-3" />
                            {ticket.messagesCount || (ticket.messages && ticket.messages.length) || 0} {(ticket.messagesCount || (ticket.messages && ticket.messages.length) || 0) === 1 ? 'reply' : 'replies'}
                          </span>
                        )}
      ...
      {pagination.totalPages > 1 && (
        <div className="flex items-center justify-between mt-6 pt-6 border-t border-white/10">
          <div className="text-sm text-gray-400">
            Showing {((pagination.page - 1) * pagination.pageSize) + 1} to {Math.min(pagination.page * pagination.pageSize, pagination.totalCount)} of {pagination.totalCount} tickets
          </div>

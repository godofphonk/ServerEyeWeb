...
const statusConfig = {
  [TicketStatus.New]: { icon: Clock, color: "text-blue-400", bg: "bg-blue-500/10", border: "border-blue-500/20", label: "New" },
  [TicketStatus.Open]: { icon: AlertCircle, color: "text-yellow-400", bg: "bg-yellow-500/10", border: "border-yellow-500/20", label: "Open" },
  [TicketStatus.InProgress]: { icon: Loader2, color: "text-purple-400", bg: "bg-purple-500/10", border: "border-purple-500/20", label: "In Progress" },
  [TicketStatus.Resolved]: { icon: CheckCircle, color: "text-green-400", bg: "bg-green-500/10", border: "border-green-500/20", label: "Resolved" },
  [TicketStatus.Closed]: { icon: XCircle, color: "text-gray-400", bg: "bg-gray-500/10", border: "border-gray-500/20", label: "Closed" },
  [TicketStatus.Reopened]: { icon: AlertCircle, color: "text-orange-400", bg: "bg-orange-500/10", border: "border-orange-500/20", label: "Reopened" }
};
                ...
                {ticket.messages.length > 0 && (
                  <div className="space-y-2">
                    ...
                    <div className="space-y-2 max-h-48 overflow-y-auto">
                      {ticket.messages.slice(-3).reverse().map((msg) => (
                        <div
                          key={msg.id}

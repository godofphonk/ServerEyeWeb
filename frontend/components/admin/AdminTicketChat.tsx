...
export function AdminTicketChat({ ticket, isOpen, onClose, onTicketUpdate }: AdminTicketChatProps) {
  ...
  const loadMessages = async () => {
    ...
    try {
      ...
      console.log('[AdminTicketChat] Loaded ticket with messages:', updatedTicket.messages?.length || 0);
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-3 mt-1">
                      ...
                      <div className={`flex items-center gap-1 px-2 py-1 rounded-full text-xs ${statusConfig[currentTicket.status].bg} ${statusConfig[currentTicket.status].color}`}>
                  ...
                  Object.entries(groupMessagesByDate(messages)).map(([date, dateMessages]) => (
                    <div key={date} className="space-y-3">
                      ...
                      {dateMessages.map((message, index) => (
                        ...
                        >
                          <div className={`flex items-start gap-3 max-w-[70%] ${message.isStaffReply ? 'flex-row-reverse' : 'flex-row'}`}>
                            ...
                            <div className={`space-y-1 ${message.isStaffReply ? 'items-end' : 'items-start'} flex flex-col`}>

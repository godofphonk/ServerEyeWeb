...
export function OAuthSettings({ className }: OAuthSettingsProps) {
  ...
  const getProviderIcon = (provider: string) => {
    switch (provider.toLowerCase()) {
      ...
      case 'microsoft':
        return (
          <svg className='w-5 h-5' viewBox='0 0 24 24' fill='currentColor'>
            <path d='M11.4 11.4H2.6V2.6h8.8v8.8zm-7.7-1.1h6.6V3.7H3.7v6.6zM21.4 11.4h-8.8V2.6h8.8v8.8zm-7.7-1.1h6.6V3.7h-6.6v6.6zM11.4 21.4H2.6v-8.8h8.8v8.8zm-7.7-1.1h6.6v-6.6H3.7v6.6zM21.4 21.4h-8.8v-8.8h8.8v8.8zm-7.7-1.1h6.6v-6.6h-6.6v6.6z'/>
          </svg>
        );
      case 'telegram':
        return (
  ...
  const availableProviders = [
    ...
    { name: 'Microsoft', key: 'microsoft', available: false, reason: 'Coming Soon' },

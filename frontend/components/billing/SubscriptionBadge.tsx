...
export function SubscriptionBadge({ className = '' }: SubscriptionBadgeProps) {
  ...
  if (isPro) {
    return (
      <div className={`inline-flex items-center px-3 py-1 rounded-full text-sm bg-gradient-to-r from-blue-500 to-purple-600 text-white font-medium ${className}`}>
  ...
  return (
    <div className={`inline-flex items-center px-3 py-1 rounded-full text-sm bg-gradient-to-r from-yellow-400 to-orange-500 text-white font-medium ${className}`}>

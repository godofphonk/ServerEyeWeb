...
const repositories = [
  {
    ...
    description: "High-performance Go REST API for server metrics collection with WebSocket support, multi-tier authentication and PostgreSQL storage",
    href: "https://github.com/godofphonk/ServerEyeAPI",
    icon: Code,
    language: "Go",
    languageColor: "bg-green-500",
    tooltip: "Core API server that collects metrics from agents, manages servers, and provides real-time data to web dashboard via WebSocket connections",
    features: [
  ...
  },
  {
    ...
    description: "High-performance Go monitoring agent for real-time system metrics collection with WebSocket communication and Telegram integration",
    href: "https://github.com/godofphonk/ServerEye",
    icon: Terminal,
    language: "Go",
    languageColor: "bg-cyan-500",
    tooltip: "Lightweight agent that runs on monitored servers, collects system metrics (CPU, memory, disk, network, temperature) and sends them to API via WebSocket",
    features: [
  ...
  },
  {
    ...
    description: "Complete monitoring platform with Next.js frontend and .NET backend for server metrics visualization and management",
    href: "https://github.com/godofphonk/ServerEyeWeb",
    icon: Globe,
    language: "TypeScript/C#",
    languageColor: "bg-gradient-to-r from-blue-500 to-purple-500",
    tooltip: "Web dashboard that displays server metrics in real-time, manages servers and users, provides authentication and beautiful data visualization",
    features: [
  ...
  },
  {
    ...
    description: "Telegram bot for server monitoring notifications and management with real-time alerts and interactive commands",
    href: "https://github.com/godofphonk/ServerEyeBot",
    icon: Terminal,
    language: "Go",
    languageColor: "bg-blue-400",
    tooltip: "Telegram bot that sends real-time alerts about server issues, allows server management through chat commands and provides quick status updates",
    features: [
                  ...
                  <div className="mb-4">
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex items-center gap-3">
                        <div className={`w-12 h-12 ${repo.languageColor}/20 rounded-xl flex items-center justify-center`}>
                          <repo.icon className="w-6 h-6 text-white" />
                        </div>
                        <div>
                          <h3 className="text-xl font-bold">{repo.name}</h3>
                          <div className="flex items-center gap-2 mt-1">
                            <span className={`px-2 py-1 ${repo.languageColor} text-white text-xs rounded-full`}>
                              {repo.language}
                            </span>
                          </div>
                        </div>

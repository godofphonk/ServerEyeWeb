...
import { AlertCircle, Info, AlertTriangle, XCircle, Search, RefreshCw, ExternalLink } from 'lucide-react';
...
export default function LogViewer() {
  ...
  const loadLogs = async () => {
    try {
      ...
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/admin/logs?limit=50&level=${level}`,
        {
          headers: {

...
/// <summary>
/// Legacy subscription controller for frontend compatibility.
/// Routes /api/subscription/* to /api/billing/subscription/*.
/// </summary>
[Authorize]
[ApiController]
[Route("api/subscription")]
public class LegacySubscriptionController : ControllerBase
{
    private readonly ISubscriptionService subscriptionService;
    private readonly ILogger<LegacySubscriptionController> logger;

    public LegacySubscriptionController(
        ISubscriptionService subscriptionService,
        ILogger<LegacySubscriptionController> logger)
    {

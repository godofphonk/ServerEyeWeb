...
public class DopplerEnvironmentConfigurationProvider : ConfigurationProvider
{
    ...
    private static string ConvertEnvironmentVariableToConfigurationKey(string envVar)
    {
        ...
        var exactMatches = new Dictionary<string, string>
        {
            ...
            ["EMAIL_SETTINGS_SMTP_HOST"] = "EmailSettings:SmtpHost",
            ["EMAIL_SETTINGS_SMTP_PORT"] = "EmailSettings:SmtpPort",
            ["EMAIL_SETTINGS_SMTP_USERNAME"] = "EmailSettings:SmtpUsername",
            ["EMAIL_SETTINGS_SMTP_PASSWORD"] = "EmailSettings:SmtpPassword",
